...
// Ketika user sudah login, maka secara otomatis ke halaman index job 
if (isset($_SESSION["login"])) {
    header("location: job.index.php"); 
    exit;
}

// User job login ke halaman index
if (isset($_POST["login"])) {
    $username = $_POST["username"];
    $password = $_POST["password"];

    $result = mysqli_query($conn, "SELECT * FROM userjob WHERE username = '$username'");
								...
								<div class="card-front">
									<div class="center-wrap">
										<div class="section text-center">
											<h4 class="mb-4 pb-3">Job GOSAM</h4>
									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<form action="" method="post">
												...
												<button class="btn mt-4" type="submit" name="register2">submit</button>
											</form>
				      					</div>
			      					</div>
			      				</div>
