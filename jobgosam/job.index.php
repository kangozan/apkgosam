...
<head>
  ...
  <title>Gabung Bersama GOSAM</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="job.index.php?page=dashboard" class="nav-link">
          ...
          <li class="nav-item">
            <a href="job.index.php?page=lamaran" class="nav-link">
          ...
          <li class="nav-item">
            <a href="job.index.php?page=verifikasi" class="nav-link">
           ...
           <!--button log out -->
          <form action="job.logout.php" method="POST">
      ...
      <!-- isi conten untuk memanggil data yg lain -->
          <?php
              ...
              if(!empty($page)){
                switch($page){
                  case 'dashboard':
                    include "dashboard.job.php";
                    break;
                  case 'lamaran':
                    include "lamaran.job.php";
                    break;
                  case 'verifikasi':
                    include "verifikasi.job.php";
                    break;
                } 
              } else {
                include "dashboard.job.php";
